...
public class GroupQueryImpl extends AbstractQuery<GroupQuery, Group> implements GroupQuery {
  ...
  protected Integer groupOrgId;
  protected String groupCode;
  protected String groupBusinessCode;
  protected String groupBusinessType;
  ...
  /**增加业务查询条件*/
  public GroupQuery groupOrgId(Integer groupOrgId){
      if (groupOrgId == null) {
          throw new ActivitiIllegalArgumentException("Provided groupOrgId is null");
        }
      this.groupOrgId=groupOrgId;
      return this;
  }
  
  public GroupQuery groupCode(String groupCode){
      if (groupCode == null) {
          throw new ActivitiIllegalArgumentException("Provided groupCode is null");
        }
      this.groupCode=groupCode;
      return this;
  }
  
  public GroupQuery groupBusinessCode(String groupBusinessCode){
      if (groupBusinessCode == null) {
          throw new ActivitiIllegalArgumentException("Provided groupBusinessCode is null");
        }
      this.groupBusinessCode=groupBusinessCode;
      return this;
  }
  
  public GroupQuery groupBusinessType(String groupBusinessType){
      if (groupBusinessType == null) {
          throw new ActivitiIllegalArgumentException("Provided groupBusinessType is null");
        }
