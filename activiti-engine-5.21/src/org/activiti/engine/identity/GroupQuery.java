...
public interface GroupQuery extends Query<GroupQuery, Group> {
  ...
  GroupQuery groupOrgId(Integer groupOrgId);
  GroupQuery groupCode(String groupCode);
  
  GroupQuery groupBusinessCode(String groupBusinessCode);
  
  GroupQuery groupBusinessType(String groupBusinessType);
